...
import cn.IRACS.core.constant.Constant;
import cn.IRACS.core.util.QueryHelper;
import cn.IRACS.nbfw.complain.entity.Complain;
import cn.IRACS.nbfw.complain.service.ComplainService;
import cn.IRACS.nbfw.info.entity.Info;
import cn.IRACS.nbfw.info.service.InfoService;
import cn.IRACS.nbfw.user.entity.User;
import cn.IRACS.nbfw.user.service.UserService;
...
public class HomeAction extends BaseAction {
	...
	public String execute(){
		...
		queryHelper1.addCondition("i.state like ?", "%1%");
		List<Info> infoList = infoService.getPageResult(queryHelper1, getPageNo(), 12).getItems();
		...
		List<Complain> complainList = complainService.getPageResult(queryHelper2, getPageNo(), 12).getItems();
