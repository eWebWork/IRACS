...
<head>
    <base href="<%=basePath%>"/>
    <link href="${ctx}/css/nbfw/css.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx}/css/nbfw/style.css" rel="stylesheet" type="text/css"/>
...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
				<dl class="">
                    <dt><a class="yh" href="${ctx }nbfw/role_listUI.action" target="mainFrame"><b></b>角色管理<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="yh" href="${ctx }nbfw/user_listUI.action" target="mainFrame"><b></b>用户管理<s class="down"></s>
                    </a></dt>
                </dl>

                <dl>
                    <dt><a class="xxfb" href="${ctx }nbfw/info_listUI.action" target="mainFrame"><b></b>信息发布管理<s
                            class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="tssl" href="${ctx }nbfw/complain_listUI.action" target="mainFrame"><b></b>投诉受理管理<s
                            class="down"></s> </a></dt>
                </dl>
                <!-- <dl class="">
                    <dt><a class="nszx" href="#" target="mainFrame"><b></b>咨询管理<s class="down"></s> </a></dt>
                </dl> -->
            </div>
        </div>
    </div>
