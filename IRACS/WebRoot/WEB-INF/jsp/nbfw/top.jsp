...
<html>
<head>
	<link href="${basePath}css/nbfw/css.css" rel="stylesheet" type="text/css" />
	<link href="${basePath}css/nbfw/style.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<body>
	<!-- 头部{ -->
	<table width="1222" border="0" align="center" cellpadding="0" cellspacing="0" background="${basePath}images/nbfw/xingzheng.png" class="top">
		<tr>
			...
			<td width="350" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
                        ...
                        <td align="center"><img src="${basePath}images/nbfw/help.png" width="12"height="17" /></td>
						<td align="left"><a href="javascript:void(0)">帮助</a></td>
						<td width="17" align="center"><img src="${basePath}images/nbfw/exit.png"width="14" height="14"/></td>
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
                ...
                <li><a href="javascript:void(0);">内部服务</a></li>
			</ul>
		</div>
	</div>
	<!-- }导航 -->
