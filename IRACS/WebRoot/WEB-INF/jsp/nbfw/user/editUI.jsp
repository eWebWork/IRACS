    ...
    var vResult = false;
    	...
    	function doVerify(){
    		...
    		if(account != ""){
    			//2、校验 
    			$.ajax({
    				url:"${basePath}nbfw/user_verifyAccount.action",
...
<form id="form" name="form" action="${basePath }nbfw/user_edit.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        <tr>
            ...
            <td><s:select name="user.dept" list="#{'总经理办公室':'总经理办公室','人力资源部':'人力资源部','财务部':'财务部','生产技术部':'生产技术部','计划营销部':'计划营销部' }"/></td>
        </tr>
        <tr>
