...
<head>
    ...
    <script type="text/javascript">
  	var list_url = "${basePath}nbfw/complain_listUI.action";
  	//搜索
  	function doSearch(){
  		//重置页号
  		$("#pageNo").val(1);
  	...
  	function doDeal(compId){
  		document.forms[0].action = "${basePath}nbfw/complain_dealUI.action?complain.compId=" + compId;
  		document.forms[0].submit();
  	}
  	//投诉统计
  	function doAnnualStatistic(){
  		document.forms[0].action = "${basePath}nbfw/complain_annualStatisticChartUI.action";
  		document.forms[0].submit();
  	}
    </script>
</head>
