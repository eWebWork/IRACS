...
<form id="form" name="form" action="" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:select id="toCompDept" name="comp.toCompDept" list="#{'':'请选择','总经理办公室':'总经理办公室','人力资源部':'人力资源部','财务部':'财务部','生产技术部':'生产技术部','计划营销部':'计划营销部' }" onchange="doSelectDept()"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><s:textarea id="editor" name="comp.compContent" cssStyle="width:90%; height:350px;"/></td>
        </tr>
