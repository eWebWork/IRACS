...
<div class="menu">
    <ul class="clearfix">
        ...
        <li><a href="${ctx}/nbfw/home_frame.action">内部服务</a> </li>
    </ul>
</div>
<!-- }导航 -->
<!-- 左{ -->
<div class="content" style="height: 720px;">
    <div class="left">
        <!-- 个人资料{ -->
        <div class="left_grzx1" style="height: 350px;">
            <div class="left_grzxbt">
                <h1>个人资料</h1>
            </div>
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="146" height="170" align="center" valign="middle">
                        <div class="left-tx" style="width: 146; height: 140;">
                            <s:if test="%{#session.SYS_USER.headImg != null && #session.SYS_USER.headImg !=''}">
                            	<img src="${ctx}/upload/<s:property value='#session.SYS_USER.headImg'/>" width="140" height="140" />
                            </s:if><s:else>
								<img src="${ctx}/images/home/gs09.png" width="140" height="140" />
							</s:else>
                        </div>
                    </td>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">所属部门：<br/><s:property value="#session.SYS_USER.dept"/></td>
                        </tr>
                    </table>
                    </td>
                </tr>
...
<!-- }左 -->
    ...
    <div class="right">
        <div class="left_grzx1" style="height: 350px;">
            <div class="left_grzxbt">
                <h1>信息列表</h1>&nbsp;<!-- <a style="line-height: 27px; font-size: 10px; " href="${ctx}/home/moreInfo.jsp">更多&gt;&gt; --></a>
            </div>
            <table width="98%" border="0" align="center">
    ...
    <div class="layout_center" style="height: 360px;">
        <div class="lc_grzx1" style="height: 350px;">
            <div class="lc_grzxbt">
                <h1>我的投诉</h1>
...
<!-- 尾部{ -->
<div class="foot" style="font-size:13px!important;">版权所有&copy;2017</div>
<!-- }尾部 -->
</body>
</html>